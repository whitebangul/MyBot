...
class Poker(commands.Cog):
    ...
    async def poker_rules(self, ctx):
        ...
        rules_text = (
            ...
            "게임 방법:\n"
            "\n"
            "모든 플레이어에게 개인 카드 2장이 주어집니다. (deal)\n"
            "플레이어들은 카드 조합을 보고 베팅 여부를 정합니다. 각 플레이어들은 베팅, 레이즈, 콜, 폴드를 할 수 있습니다.\n"
            "모두가 동의했다면 커뮤니티 카드 3장을 공개합니다. (flop)\n"
            "플레이어들은 개인 카드 2장과 커뮤니티 카드를 조합해 높은 족보를 만들어야 합니다.\n"
            "배팅 여부를 정한 뒤, 모두가 동의했다면 4번째 커뮤니티 카드를 공개합니다. (turn)\n"
            "똑같이 배팅 여부를 정한 뒤, 모두가 동의했다면 마지막 커뮤니티 카드를 공개합니다.\n"
            "모든 커뮤니티 카드가 공개됐다면, 플레이어들은 자신의 카드 조합을 공개해 승자를 정합니다.\n"
            "**카드 조합 예시 (강한 순):**\n"
